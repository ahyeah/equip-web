    ...
    public class Kpi : BaseDAO
    {
        ...
        public List<A15dot1TabQiYe> GetJxByA2(DateTime astime,DateTime aetime, string zzname, string zy)
        {
            ...
            using (var db = base.NewDB())
            {
                ...
                //查出全厂的数据，超级用户修改计算出的全厂的数据后就在这里查询
                    ...
                    return db.A15dot1TabQiYe.Where(a => a.submitDepartment == zzname && a.temp2 == zy && a.submitTime >= astime && a.submitTime <= aetime).ToList();
                    //&& a.submitTime <= Convert.ToDateTime(etime)
               
            }
        }//取企业级表中的数据
        public List<A15dot1TabJing> GetJxRecordJing(string time, string zzname, string zy)
        {
            DateTime Cxtime = DateTime.Now;
            string stime;
            string etime;
            using (var db = base.NewDB())
            {
                ...
                return db.A15dot1TabJing.Where(a => a.submitDepartment == zzname && a.temp2 == zy && a.submitTime >= astime && a.submitTime <= aetime).ToList();
                //&& a.submitTime <= Convert.ToDateTime(etime)
            }
        }//取静设备专业表中的数据
        public List<A15dot1TabDian> GetJx1Record(string time, string zzname, string zy)
        {
            DateTime Cxtime = DateTime.Now;
            string stime;
            string etime;
            using (var db = base.NewDB())
            {
                ...
                return db.A15dot1TabDian.Where(a => a.submitDepartment == zzname && a.temp2 == zy && a.submitTime >= astime && a.submitTime <= aetime).ToList();
                //&& a.submitTime <= Convert.ToDateTime(etime)
            }
        }//取电气专业表中的数据

        public List<A15dot1TabYi> GetJx2Record(string time, string zzname, string zy)
        {
            DateTime Cxtime = DateTime.Now;
            string stime;
            string etime;
            using (var db = base.NewDB())
            {
                ...
                DateTime astime = Convert.ToDateTime(stime);
                DateTime aetime = Convert.ToDateTime(etime);
                return db.A15dot1TabYi.Where(a => a.submitDepartment == zzname && a.temp2 == zy && a.submitTime >= astime && a.submitTime <= aetime).ToList();
                //&& a.submitTime <= Convert.ToDateTime(etime)
            }
        }//取仪表专业表中的数据
        ...
        public List<A15dot1TabDong> GetDongJxByA2(string time, string zzname, string zy)
        {
            ...
            using (var db = base.NewDB())
            {
                ...
                DateTime astime = Convert.ToDateTime(stime);
                DateTime aetime = Convert.ToDateTime(etime);
                return db.A15dot1TabDong.Where(a => a.submitDepartment == zzname && a.temp2 == zy && a.submitTime >= astime && a.submitTime <= aetime).ToList();
                //&& a.submitTime <= Convert.ToDateTime(etime)
            }
        }
