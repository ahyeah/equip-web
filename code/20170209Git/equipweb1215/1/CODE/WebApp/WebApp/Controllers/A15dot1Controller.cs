...
namespace WebApp.Controllers
{
    public class A15dot1Controller : CommonController
    {
      ...
      public class KPIIndex
      {
        ...
        {
            public List<KPIIndex> Am;
            public List<KPIIndex> Hm;
            public int isSubmit;
            public int kkxgcs;
            public int am;
            public int hm;
        ...
        public Index_ModelforA15 getRecord()
        {
            ...
            EquipBLL.AdminManagment.PersonManagment.P_viewModal pv = pm.Get_PersonModal(UserId);
            RecordforA15.Am = new List<KPIIndex>();
            ...
            {
                KPIIndex a = new KPIIndex();
                
                a.index = index;
                a.dep = item.submitDepartment;
                a.submituser = item.submitUser;
                a.submittime = item.submitTime.ToString();          
                a.zy =item.temp2;          
                a.state = item.state;
                a.id = item.Id;
                index++;
            ...
            KpiManagement Jx1 = new KpiManagement();
            List<A15dot1TabQiYe> miss1 = Jx1.GetJxItem(pv.Role_Names, pv.Department_Name, pv.Person_Name,cjname);
           
            foreach (var item in miss1)
            {
                KPIIndex a = new KPIIndex();
