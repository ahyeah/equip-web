...
namespace WebApp
{
    ...
    {
        private const string DummyPageUrl = @"http://localhost:2279/Cache/Index";
        ...
        private void RegisterCacheEntry()
        {
            ...
            if (HttpContext.Current.Cache[DummyKey] != null)
                return;
            HttpContext.Current.Cache.Add(DummyKey, "Timer", null, DateTime.MaxValue, TimeSpan.FromMinutes(5), System.Web.Caching.CacheItemPriority.NotRemovable,
